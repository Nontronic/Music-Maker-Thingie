...
def buildButtons():
    ...
    for i in range(0, 105):     
        if i%7 == 0:
             sound = "a_Major_piano.wav"
             note = "A"
             note2 = "A+"
        elif i%7 == 1:
             sound = "b_Major_piano.wav"
             note = "B"
             note2 = "B+"
        elif i%7 == 2:
             sound = "c_Major_piano.wav"
             note = "C"
             note2 = "C+"
        elif i%7 == 3:
             sound = "d_Major_piano.wav"
             note = "D"
             note2 = "D+"
        elif i%7 == 4:
             sound = "e_Major_piano.wav"
             note = "E"
             note2 = "E+"
        elif i%7 == 5:
             sound = "f_Major_piano.wav"
             note = "F"
             note2 = "F+"
        elif i%7 == 6:
             sound = "g_Major_piano.wav"
             note = "G"
             note2 = "G+"
...
playButton = button(718.75, 35, 187.5, 50, blue, "bruh.mp3", "bruh", "bruh")
playSprites.add(playButton)

clearButton = button(503.75, 35, 187.5, 50, blue, "bruh.mp3", "bruh", "bruh")
clearSprites.add(clearButton)

octaveX = 42.5

for i in range(15):
     octaveButton = button(octaveX, 720, 40, 40, blue, "bruh.mp3", "bruh", "bruh")
     octaveSprites.add(octaveButton)
     octaveX += 85

bruhButton = button(1310, 290, 50, 50, blue, "bruh.mp3", "Br", "bruh")
oofButton = button(1310, 375, 50, 50, blue, "oof.mp3", "Of", "oof")
naniButton = button(1310, 460, 50, 50, blue, "Nani.mp3", "Na", "oof")
